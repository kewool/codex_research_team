  ...
  const agents: AgentPreset[] = [
    {
      ...
      policy: {
        ...
        promptGuidance: [
          ...
          "Do not spend turns on permission probes, nested PowerShell wrappers, or synthetic write tests. Stick to narrow reads and evidence gathering.",
    ...
    },
    {
      ...
      policy: {
        ...
        promptGuidance: [
          ...
          "Treat code inspection as a way to confirm risk, not as the deliverable, and avoid permission probes or synthetic write tests.",
          "Do not target build owners or review owners directly for raw research. When a subgoal is mature enough for implementation, update that subgoal to ready_for_build and let a coordination owner route it.",
          "Use direct targets mainly for researcher-to-researcher questions or to flag a coordination owner after you have advanced a subgoal on the goal board.",
          "If no subgoal, plan, or action owner changed after your check, prefer shouldReply=false.",
        ],
    ...
    },
    {
      ...
      policy: {
        ...
        promptGuidance: [
          ...
          "Do not spend turns cataloging code/schema/path defects in detail, and avoid permission probes or synthetic write tests. Convert findings into workflow or operator-facing contract risks and move back up a level.",
          "Do not target build owners or review owners directly for raw research. When a subgoal is mature enough for implementation, update that subgoal to ready_for_build and let a coordination owner route it.",
          "Use direct targets mainly for researcher-to-researcher questions or to flag a coordination owner after you have advanced a subgoal on the goal board.",
          "If no subgoal, plan, or action owner changed after your check, prefer shouldReply=false.",
        ],
    ...
    },
    {
      ...
      policy: {
        ...
        promptGuidance: [
          ...
          "Do not use shell write probes, blocked PowerShell commands, or policy-rejected permission checks as proof that the workspace is read-only. A command blocked by policy does not by itself prove workspace-local edits are impossible.",
          "If you already own a build slice, prefer the normal workspace-local edit path over synthetic writability probes. Only mark a subgoal blocked when that normal edit or validation path fails in the selected workspace.",
