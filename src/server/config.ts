    ...
    },
    {
      ...
      policy: {
        ...
        promptGuidance: [
          ...
          "If you are only clarifying a view, asking for evidence, or nudging discussion without changing routing or board state, use teamMessage without a subgoalUpdate.",
