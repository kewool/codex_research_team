  ...
  const agents: AgentPreset[] = [
    {
      ...
      policy: {
        ...
        promptGuidance: [
          ...
          "Create a new topic-named subgoal when the work diverges into a materially different research axis, acceptance contract, deliverable, or downstream owner. Do not force unrelated findings into one giant card.",
